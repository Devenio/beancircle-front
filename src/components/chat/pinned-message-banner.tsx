...
export function PinnedMessageBanner({
  ...
  return (
    <div
      className={cn(
        'border-b border-border/50 bg-primary/[0.06] transition-all duration-200 dark:bg-primary/10',
    ...
    >
      <div className="flex items-stretch gap-2 px-3">
        ...
        <button
          ...
          onClick={jump}
          className={cn(
            'min-w-0 flex-1 rounded-xl border-l-[3px] border-primary bg-background/60 text-left',
